...
<head>
    ...
    <title>Регистрация | АЙТЕРОСС</title>
    <style>
...
<body>
    ...
    <main class="auth">
        <div class="card">
            <h1>Регистрация</h1>
            <p>Создайте личный кабинет для работы с заявками, заказами и избранным.</p>
            ...
            <form action="{{ route('register.store') }}" method="post">
                ...
                <div class="field">
                    ...
                    <input id="first_name" name="first_name" type="text" value="{{ old('first_name') }}" placeholder="Иван" required>
                </div>

                <div class="field">
                    <label for="last_name">ФАМИЛИЯ</label>
                    <input id="last_name" name="last_name" type="text" value="{{ old('last_name') }}" placeholder="Иванов" required>
                </div>

                <div class="field">
                    <label for="company">КОМПАНИЯ</label>
                    <input id="company" name="company" type="text" value="{{ old('company') }}" placeholder="ООО Компания" required>
                </div>
                ...
                <div class="field">
                    ...
                    <input id="phone" name="phone" type="tel" value="{{ old('phone') }}" placeholder="+7 (___) ___-__-__" required>
                </div>

                <div class="field">
                    <label for="password">ПАРОЛЬ</label>
                    <div class="password-field">
                        <input id="password" name="password" type="password" placeholder="Не менее 8 символов" required>
                ...
                <div class="field field--last">
                    ...
                    <div class="password-field">
                        <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Повторите пароль" required>
                        <button type="button" class="password-toggle" data-password-toggle="password_confirmation" aria-label="Показать пароль" aria-pressed="false">
                            <svg data-eye-open viewBox="0 0 24 24" width="22" height="22" fill="none" aria-hidden="true">
                                <path d="M2 12C3.73 8.11 7.53 5.5 12 5.5C16.47 5.5 20.27 8.11 22 12C20.27 15.89 16.47 18.5 12 18.5C7.53 18.5 3.73 15.89 2 12Z" stroke="currentColor" stroke-width="1.7"/>
                                <circle cx="12" cy="12" r="3.25" stroke="currentColor" stroke-width="1.7"/>
                            </svg>
